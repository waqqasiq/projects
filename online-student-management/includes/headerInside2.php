        ...
        <?php if(isset($_SESSION['uid'])===TRUE) {?>
            ...
            <li style="width: auto;float: left; margin-left: 20px;">
                <button type="button" class="btn btn-default btn-sm">
                    <a href="dashboard.php?stdid=<?php echo $_SESSION['uid']?>">Dashboard</a>
                </button>
            </li>
            <li style="width: auto;float: left; margin-left: 20px;">
                <button type="button" class="btn btn-default btn-sm">
		...
		<nav class="navbar navbar-default navbar-left" role="navigation">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<li ><a href="admin-page.php">Account</a></li>
                    <li><a href="routine-fix.php">Advising</a></li>
                    <li><a href="gradeform2.php">Assign Grade</a></li>
                    <li><a href="sub-list.php">Subject</a></li>
                    
                    <li><a href="notice-list2.php">Notice</a></li>
                    <li><a href="contactAdmin2.php">Contact</a></li>
                    <li><a href="admin-all.php">Admin</a></li>
                    <li><a href="adminAbout2.php">About</a></li>
