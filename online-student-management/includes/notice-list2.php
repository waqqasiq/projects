			    ...
			    <div class="col-md-12 company_ad">
				   <!-- <a href="logout.php" style="float:right; font-size:16px; color: brown" >Logout</a>
      				<!--<address>
				   	...
				   	<br><a href="add-notice2.php" class="btn btn-danger">Add New </a><br/>
            <table class="table table-bordered" style="width:100%; font-weight:550;">
                ...
                while ($subject = mysqli_fetch_assoc($result)){// $department = mysqli_fetch_assoc($res)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a
                                style="color:DarkCyan" href="change-notice.php?nid=<?php echo $subject['nid']?>">Edit
                            </a>
                        </td>
                        <td>
                            <a style="color:brown" title="Delete"  href="notice-list2.php?act=del&nid= <?php echo $subject['nid'] ?>">Delete
                            </a>
                        </td>
                    </tr>
                <?php
