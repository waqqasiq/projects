			    ...
			    <div class="col-md-12 company_ad">
				   <!-- <a href="logout.php" style="float:right; font-size:16px; color: brown" >Logout</a>
      				<!--<address>
				   	...
				   	<br><a href="add-subr.php" class="btn btn-danger">Add New </a><br/>
            <table class="table table-bordered" style="width:100%; font-weight:550;">
                ...
                while ($subject = mysqli_fetch_assoc($result)){// $department = mysqli_fetch_assoc($res)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a
                                style="color:DarkCyan" href="edit-sub.php?subjectid=<?php echo $subject['sub_id']?>">Edit
                            </a>
                        </td>
                        <td>
                            <a style="color:brown" title="Delete"  href="sub-list.php?act=del&subjectid= <?php echo $subject['sub_id'] ?>">Delete
                            </a>
                        </td>
                    </tr>
                <?php
