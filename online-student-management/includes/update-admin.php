				...
				<div class="col-md-6">
				  <div class="contact-form">
					    	...
					    	<div>
						    	...
						    	<span><input type="text" name="name" id='name' class="form-control" value="<?php echo $adminInfo['name'];?>"/></span>
						    </div>
						</div>
					</div>
						...
						<div class="contact-form">
						    <div>
						    	<span>Admin Email</span>
                                        <span><input type="text" name="mail" id='mail' class="form-control" value="<?php echo $adminInfo['email'];?>"/></span>
						    </div>
						</div>
					</div>
